...
from pcl_core.vault.keys import ACCOUNT, SERVICE

from hub_desktop.pin import TOOL_NAME, running_from_uv_tool, uv_executable
...
MISSING_UV_UNINSTALL = "uv tool uninstall personal-context-hub"
MISSING_UV_UPGRADE = "uv tool upgrade personal-context-hub"
