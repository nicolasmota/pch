...
Omission categories: `scope_not_granted`, `classification_ceiling`, `capability_missing`, `policy_exclusion`.

Field-level schema: [Data model](../reference/data-model.md#context-contract).
