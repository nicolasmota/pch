...
from pcl_sdk.sim.persona import QUERY_ACTIONS, compile_persona
from pcl_sdk.sim.records import load_run, save_run, save_ticks
...
def mint_assistant(hub: Hub, project_id: str | None = None) -> dict[str, Any]:
    link = hub.mint_link("sim-assistant")
