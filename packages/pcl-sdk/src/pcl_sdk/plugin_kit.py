...
SKELETON_SYNC = '''from pcl_sdk.plugin_runtime import hub
...
def cmd_dev(plugin_dir: Path, hub_base: str) -> None:
    ...
    print("Pack with `pcl-sdk plugin pack` then POST /v1/plugins with source=sideload.")


def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="pcl-sdk plugin")
