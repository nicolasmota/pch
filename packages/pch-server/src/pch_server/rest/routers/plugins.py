...
from pch_core.errors import ConsentRequired, NotFound, ValidationFailed
from pch_core.schema.audit import EventKind
from pch_core.service import Hub
from pydantic import BaseModel

from pch_server.plugins.host import isolation_mode, run_plugin_sync
from pch_server.plugins.package import load_manifest, manifest_to_snapshot, unpack_package
from pch_server.plugins.paths import bundled_dir, plugins_root
...
def update_preview(installation_id: str, hub: Hub = Depends(get_hub), _: str = Depends(require_owner)) -> dict:
    from pch_server.rest.routers.marketplace import update_preview as mp_preview
...
def apply_update(installation_id: str, hub: Hub = Depends(get_hub), _: str = Depends(require_owner)) -> dict:
    from pch_server.rest.routers.marketplace import apply_update as mp_update
